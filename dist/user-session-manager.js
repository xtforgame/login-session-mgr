...
exports.UserSessionManager = exports.LoggedInUser = undefined;
...
var LoggedInUser = exports.LoggedInUser = function LoggedInUser(_ref) {
  var uid = _ref.uid,
      _ref$data = _ref.data,
      data = _ref$data === undefined ? {} : _ref$data,
      _ref$sessions = _ref.sessions,
      sessions = _ref$sessions === undefined ? {} : _ref$sessions;
...
var UserSessionManager = exports.UserSessionManager = (_temp = _class = function () {
  ...
  _createClass(UserSessionManager, [{
    ...
    value: function login(userUid, sessionUid) {
      ...
      return this.sessionManager.login(sessionUid, sessionData).then(function (newSession) {
        ...
        if (!user) {
          isNewUser = true;
          user = new _this.UserInfoClass({ uid: userUid });
...
}(), _class.LogoutReason = _sessionManager.SessionManager.LogoutReason, _class.ErrorMessage = _sessionManager.SessionManager.ErrorMessage, _temp);