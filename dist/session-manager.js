...
var LoggedInSession = exports.LoggedInSession = function LoggedInSession(_ref) {
  var uid = _ref.uid,
      _ref$data = _ref.data,
      data = _ref$data === undefined ? {} : _ref$data,
      _ref$updatedTime = _ref.updatedTime,
      updatedTime = _ref$updatedTime === undefined ? new Date().getTime() : _ref$updatedTime,
...
var ActivityMap = exports.ActivityMap = function () {
...
function assignCallbackFuncs(_this, options) {
  ...
  var _options$ = options['on' + prefixForOptions + 'LoggedIn'],
      onLoggedIn = _options$ === undefined ? function (session) {} : _options$,
      _options$2 = options['on' + prefixForOptions + 'DuplicateLogin'],
      onDuplicateLogin = _options$2 === undefined ? function (existedSession, newSession, logoutExistedOne, denyLogin) {
    logoutExistedOne();
    denyLogin();
  } : _options$2,
      _options$3 = options['on' + prefixForOptions + 'UnexpectedLoggedOut'],
      onUnexpectedLoggedOut = _options$3 === undefined ? function (session, reason) {} : _options$3,
      _options$4 = options['on' + prefixForOptions + 'ReloggedIn'],
      onReloggedIn = _options$4 === undefined ? function (session, newData) {} : _options$4,
      _options$5 = options['on' + prefixForOptions + 'LoggedOut'],
      onLoggedOut = _options$5 === undefined ? function (session, reason) {} : _options$5;


  var underscore = useUnderscoreForThis ? '_' : '';
  Object.assign(_this, (_Object$assign = {}, _defineProperty(_Object$assign, underscore + 'on' + prefixForOptions + 'LoggedIn', onLoggedIn), _defineProperty(_Object$assign, underscore + 'on' + prefixForOptions + 'DuplicateLogin', onDuplicateLogin), _defineProperty(_Object$assign, underscore + 'on' + prefixForOptions + 'UnexpectedLoggedOut', onUnexpectedLoggedOut), _defineProperty(_Object$assign, underscore + 'on' + prefixForOptions + 'ReloggedIn', onReloggedIn), _defineProperty(_Object$assign, underscore + 'on' + prefixForOptions + 'LoggedOut', onLoggedOut), _Object$assign));
}

var SessionManager = exports.SessionManager = (_temp = _class = function () {
